...
#pragma warning restore CS0618 // Type or member is obsolete
		...
		public class _42329_FrameWithListView : ContentPageEx
		{
			...
			{
				var lv = new ListView();
				var label = new Label { Text = LabelPage1, AutomationId = "Page1Title" };
		...
		public class _42329_Page2 : ContentPage
		{
			public _42329_Page2()
			{
				...
				{
					Text = LabelPage2,
					AutomationId = "Page2Title" // Set AutomationId to Page2Title
				};
		...
		public class _42329_Page3 : ContentPage
		{
			...
			public _42329_Page3()
			{
				...
				otherLabel = new Label
				{
					...
					AutomationId = "Destructor called"
				};
				Content = new StackLayout
				{
					Children =
			...
			protected override void OnAppearing()
			{
				...
				otherLabel.AutomationId = "Destructor called";
			}
		}
	}
}